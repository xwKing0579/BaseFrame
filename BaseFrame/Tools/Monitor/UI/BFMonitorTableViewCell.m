//
//  BFMonitorTableViewCell.m
//  OCProject
//
//  Created by 王祥伟 on 2023/12/20.
//

#import "BFMonitorTableViewCell.h"

@interface BFMonitorTableViewCell ()
@property (nonatomic, strong) UILabel *titleLabel;
@property (nonatomic, strong) UIView *lineView;
@property (nonatomic, strong) UIImageView *arrowImageView;
@end

@implementation BFMonitorTableViewCell
+ (instancetype)initWithTableView:(UITableView *)tableView withObject:(BFMonitorModel *)model{
    BFMonitorTableViewCell *cell = [self initWithTableView:tableView];
