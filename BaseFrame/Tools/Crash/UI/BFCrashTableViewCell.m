//
//  BFCrashTableViewCell.m
//  OCProject
//
//  Created by 王祥伟 on 2023/12/14.
//

#import "BFCrashTableViewCell.h"
@interface BFCrashTableViewCell ()
...
@implementation BFCrashTableViewCell

+ (instancetype)initWithTableView:(UITableView *)tableView withObject:(BFCrashModel *)model{
    BFCrashTableViewCell *cell = [self initWithTableView:tableView];
