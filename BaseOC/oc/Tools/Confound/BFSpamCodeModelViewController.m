//
//  BFSpamCodeModelViewController.m
//  OCProject
//
//  Created by 王祥伟 on 2024/3/22.
//

#import "BFSpamCodeModelViewController.h"
#import "BFConfoundModel.h"
#import "BFConfoundSetting.h"
#import <iCarousel.h>
@interface BFSpamCodeModelViewController ()<iCarouselDelegate,iCarouselDataSource>
@property (nonatomic, strong) iCarousel *iCarousel;
@property (nonatomic, strong) UITextView *textView;
@end

@implementation BFSpamCodeModelViewController
...
- (void)viewDidLoad {
    ...
    self.data = [BFConfoundModel data_file];
