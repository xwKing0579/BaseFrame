//
//  BFConfoundTableViewCell.m
//  OCProject
//
//  Created by 王祥伟 on 2024/3/22.
//

#import "BFConfoundTableViewCell.h"
#import "BFConfoundModel.h"
#import "BFConfoundSetting.h"
@interface BFConfoundTableViewCell ()
...
@implementation BFConfoundTableViewCell

+ (instancetype)initWithTableView:(UITableView *)tableView withObject:(BFConfoundModel *)obj{
    BFConfoundTableViewCell *cell = [self initWithTableView:tableView];
...
- (void)clickSelectAction:(UIButton *)sender{
    ...
    [BFConfoundModel editContent:@(sender.selected) idStr:self.model.idStr];
}
