//
//  BFConfoundLabelTableViewCell.m
//  OCProject
//
//  Created by 王祥伟 on 2024/3/27.
//

#import "BFConfoundLabelTableViewCell.h"
#import "BFConfoundModel.h"
@interface BFConfoundLabelTableViewCell ()
...
@implementation BFConfoundLabelTableViewCell

+ (instancetype)initWithTableView:(UITableView *)tableView withObject:(BFConfoundModel *)obj{
    BFConfoundLabelTableViewCell *cell = [self initWithTableView:tableView];
